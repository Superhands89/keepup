...
using nikonkeep.Annotations;
using nikonkeep.Classes;
using nikonkeep.Schedules;
using nikonkeep.Utilities;
...
namespace nikonkeep.ViewModels
{
        ...
        private void Settings_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            try
            {
                ...
                switch (e.PropertyName)
                {
                    ...
                    //            key?.SetValue("NikonPrint", $"\"{Assembly.GetExecutingAssembly().Location}\" /WorkingDirectory:\"{StaticCode.WorkingDirectory}\"");
                    //        }
                    //        else
                    //        {
                    //            var key = Microsoft.Win32.Registry.CurrentUser.OpenSubKey(@"Software\Microsoft\Windows\CurrentVersion\Run", true);
                    //            key?.DeleteValue("NikonPrint");
                    //        }
